...
class Xcforum_Updater
{
    ...
    **/
    ...
    {
        Xcforum_InstallUtils::uninstallAllOfModuleTemplates($this->_mTargetXoopsModule,$this->mLog);
        Xcforum_InstallUtils::installAllOfModuleTemplates($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        Xcforum_InstallUtils::smartUpdateAllOfBlocks($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        Xcforum_InstallUtils::smartUpdateAllOfConfigs($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        $this->mLog->addReport(_MI_XCFORUM_INSTALL_MSG_UPDATE_STARTED);
    ...
    **/
    private function _processReport()
    {
        if(!$this->mLog->hasError())
        {
            $this->mLog->add(
                XCube_Utils::formatString(
                    _MI_XCFORUM_INSTALL_MSG_MODULE_UPDATED,
        ...
        else
        {
            $this->mLog->add(
                XCube_Utils::formatString(
                    _MI_XCFORUM_INSTALL_ERROR_MODULE_UPDATED,
                    $this->_mCurrentXoopsModule->get('name')
                )
            );
        }
