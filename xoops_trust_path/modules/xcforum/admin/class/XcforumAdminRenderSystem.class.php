...
define('XCFORUM_ADMIN_RENDER_TEMPLATE_DIRNAME','templates');
define('XCFORUM_ADMIN_RENDER_FALLBACK_PATH',XOOPS_MODULE_PATH . '/legacy/admin/theme');    // TODO will be use other path
define('XCFORUM_ADMIN_RENDER_FALLBACK_URL',XOOPS_MODULE_URL . '/legacy/admin/theme');    // TODO will be use other url

/**
 * Xcforum_AdminRenderSystem
**/
class Xcforum_AdminRenderSystem extends Legacy_AdminRenderSystem
{
    /**
     * prepare
     * 
    ...
    **/
    public function renderTheme(/*** XCube_RenderTarget ***/ &$target)
    {
       $module =& $this->mController->getVirtualCurrentModule();
        ...
        $info = Xcforum_AdminRenderSystem::getOverrideFileInfo('admin_theme.html');
        $this->mSmarty->template_dir = ($info['file'] != null) ?
            substr($file['path'],0,-15) :
            XCFORUM_ADMIN_RENDER_FALLBACK_PATH;
    ...
    **/
    ...
    {
        $info = Xcforum_AdminRenderSystem::getOverrideFileInfo($target->getTemplateName());
    ...
    **/
    ...
    {
        $info = Xcforum_AdminRenderSystem::getOverrideFileInfo($str);
        if($info['url'] != null)
        {
            return $info['url'];
        }
        return XCFORUM_ADMIN_RENDER_FALLBACK_URL . '/' . $str;
    }
    ...
    **/
    public static function functionStylesheet(/*** {string 'file',string 'media'} ***/ $param,/*** Smarty ***/ &$smarty)
    {
        ...
        $info = Xcforum_AdminRenderSystem::getOverrideFileInfo($params['file'],'stylesheets/');
        if($info['file'] == null)
        {
            return;
        }
