...
/**
 * Xcforum_PosthistoriesEditAction
**/
class Xcforum_PosthistoriesEditAction extends Xcforum_AbstractEditAction
{
    ...
    **/
    ...
    {
        $render->setTemplateName($this->mAsset->mDirname . '_posthistories_edit.html');
