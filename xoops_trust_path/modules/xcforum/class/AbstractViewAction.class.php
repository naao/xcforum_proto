...
/**
 * Xcforum_AbstractViewAction
**/
abstract class Xcforum_AbstractViewAction extends Xcforum_AbstractAction
{
	...
	**/
	...
	{
		//$this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME'), 'list'), 1, _MD_XCFORUM_ERROR_CONTENT_IS_NOT_FOUND);
	}
}
