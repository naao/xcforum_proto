...
require_once XCFORUM_TRUST_PATH . '/class/AbstractAccessController.class.php';

/**
 * Xcforum_GroupAccessController
**/
class Xcforum_GroupAccessController extends Xcforum_AbstractAccessController
{
	public $mType = 'group';
