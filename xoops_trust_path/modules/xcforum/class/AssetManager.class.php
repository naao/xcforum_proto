...
/**
 * Xcforum_AssetManager
**/
class Xcforum_AssetManager
{
    public /*** string ***/ $mDirname = '';

    public /*** string ***/ $mTrustDirname = 'xcforum';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Xcforum_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Xcforum_AssetManager[]
        **/
    ...
    **/
    ...
    {
        return XCFORUM_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
