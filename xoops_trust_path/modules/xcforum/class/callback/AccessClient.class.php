...
**/
class Xcforum_CatClientDelegate implements Legacy_iCategoryClientDelegate
{
    /**
     * getClientList
     *
    ...
    public static function getClientList(/*** mixed[] ***/ &$list, /*** string ***/ $cDirname)
    {
		...
		foreach($dirnames as $dir){
            ...
            if(Xcforum_Utils::getModuleConfig($dir, 'access_controller')==$cDirname){
           $list[] = array('dirname'=>$dir, 'dataname'=>'forums', 'fieldname'=>'category_id');
    ...
    public static function getClientData(/*** mixed ***/ &$list, /*** string ***/ $dirname, /*** string ***/ $dataname, /*** string ***/ $fieldname, /*** int ***/ $catId)
    {
        ...
        //setup client module info
        $cri = Xcforum_Utils::getListCriteria($dirname, $catId);
...
**/
class Xcforum_GroupClientDelegate implements Legacy_iGroupClientDelegate
{
    /**
     * getClientList
     *
    ...
    public static function getClientData(/*** mixed ***/ &$list, /*** string ***/ $dirname, /*** string ***/ $dataname, /*** string ***/ $fieldname, /*** int ***/ $groupId)
    {
        ...
        //setup client module info
        $cri = Xcforum_Utils::getListCriteria($dirname, $groupId);
        $objs = $handler->getObjects($cri, $limit, $start);
        if(count($objs)>0){
	        $list['dirname'][] = $dirname;
	        $list['dataname'][] = $dataname;
