...
/**
 * Xcforum_TopicsDeleteAction
**/
class Xcforum_TopicsDeleteAction extends Xcforum_AbstractDeleteAction
{
	...
	**/
	...
	{
		$render->setTemplateName($this->mAsset->mDirname . '_topics_delete.html');
