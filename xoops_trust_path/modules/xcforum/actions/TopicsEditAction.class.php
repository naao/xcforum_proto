...
/**
 * Xcforum_TopicsEditAction
**/
class Xcforum_TopicsEditAction extends Xcforum_AbstractEditAction
{
    ...
    **/
    ...
    {
        $render->setTemplateName($this->mAsset->mDirname . '_topics_edit.html');
