...
require_once dirname(dirname(__FILE__)).'/class/comment/Abstract.class.php' ;
require_once dirname(dirname(__FILE__)).'/include/common_functions.php' ;


// old interface
function xcforum_display_comment_topicscount( $mydirname , $forum_id , $params , $mode = 'post' , &$smarty )
{
...
adump($mydirname);
	...
	if( xcforum_common_is_necessary_antispam( $xoopsUser , $xoopsModuleConfig ) ) {
